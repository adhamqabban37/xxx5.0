...
console.log('✅ Names under 60 chars:', contactBreadcrumbs.every(b => b.name.length <= 60));
console.log('✅ Sequential positions:', contactBreadcrumbs.every((b, i) => b.position === i + 1));
...
console.log('✅ Names under 60 chars:', roiBreadcrumbs.every(b => b.name.length <= 60));
console.log('✅ Sequential positions:', roiBreadcrumbs.every((b, i) => b.position === i + 1));
...
const caseStudyWebPageSchema = generateWebPageSchema('/case-studies/auto-detailing-dallas', caseStudyBreadcrumbs, baseUrl, {
...
console.log('✅ Names under 60 chars:', caseStudyBreadcrumbs.every(b => b.name.length <= 60));
console.log('✅ Sequential positions:', caseStudyBreadcrumbs.every((b, i) => b.position === i + 1));
...
function validateBreadcrumbSchema(schema) {
  const checks = {
    ...
    allItemsValid: schema.itemListElement.every(item => 
      item["@type"] === "ListItem" &&
