...
console.log(`✅ All HTTPS: ${enhancedSameAs.every(url => url.startsWith('https://')) ? 'PASS' : 'FAIL'}`);
console.log(`✅ Unique domains: ${new Set(enhancedSameAs.map(url => new URL(url).hostname)).size === enhancedSameAs.length ? 'PASS' : 'FAIL'}`);
