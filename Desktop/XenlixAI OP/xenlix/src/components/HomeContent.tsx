        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-orange-900/30 backdrop-blur-sm border border-orange-600 rounded-xl p-8 text-center">
              ...
              <p className="text-gray-300">
                <span className="text-orange-400 font-bold">Page speed issues, broken links, missing meta tags</span> affect your rankings. <span className="text-sm text-gray-400">(SEO — Coming Soon)</span>
              </p>
            </div>
            ...
            <div className="bg-yellow-900/30 backdrop-blur-sm border border-yellow-600 rounded-xl p-8 text-center">
              ...
              <p className="text-gray-300">
                <span className="text-yellow-400 font-bold">Local customers can't find you</span> in AI search results. <span className="text-sm text-gray-400">(SEO — Coming Soon)</span>
              </p>
            </div>
            ...
            <div className="bg-cyan-900/30 backdrop-blur-sm border border-cyan-600 rounded-xl p-8 text-center">
              ...
              <p className="text-gray-300">
                <span className="text-cyan-400 font-bold">Thin content and poor AI readiness</span> mean you're invisible to AI search engines.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Ready to dominate local search? <Link href="/calculators/pricing" className="text-cyan-400 hover:text-cyan-300 underline">Calculate your marketing ROI</Link> and see how our AI platform can transform your business.
            </p>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Every day you wait, competitors are capturing customers who can't find you in AI engines. Our free AEO preview reveals exactly what's costing you business.
          </p>
