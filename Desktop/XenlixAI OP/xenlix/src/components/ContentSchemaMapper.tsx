  ...
  '/': [
    {
      ...
      answer: "XenlixAI is an Answer Engine Optimization (AEO) platform helping businesses get found in AI search engines like ChatGPT, Claude, Perplexity, and Google AI. We also offer traditional SEO services."
    },
    {
      question: "Who is XenlixAI for?",
      answer: "Small to medium businesses, startups, and entrepreneurs looking to improve their SEO rankings and organic traffic with AI-powered automation."
    },
    {
      question: "How does AEO work?",
      answer: "AEO optimizes content for AI engines through structured data, conversational content, and question-answer formats that AI engines prefer for citations and answers."
    },
    {
      question: "How much does XenlixAI cost?",
      answer: "We offer flexible plans starting with a free AEO audit. Premium plans include advanced analytics, automated optimization, and priority support."
    }
  ],
  ...
  '/contact': [
    {
      ...
      answer: "You can reach us through our contact form, email hello@xenlix.ai, or book a free consultation directly through our website."
    },
    {
      question: "What is your response time?",
      answer: "We typically respond to inquiries within 24 hours during business days. For urgent matters, please mention 'urgent' in your subject line."
    },
    {
      question: "Do you offer free consultations?",
      answer: "Yes, we offer free 30-minute consultations to discuss your AEO and AI marketing needs. Book through our contact form."
    }
  ],
  ...
  '/aeo-scan': [
    {
      ...
      answer: "An AEO audit analyzes your website's visibility in AI search engines like ChatGPT and Claude, identifying optimization opportunities for better AI citations."
    },
    {
      question: "How long does the audit take?",
      answer: "Our free AEO audit generates results in under 60 seconds, providing your AI visibility score and actionable improvement recommendations."
    },
    {
      question: "Is the AEO audit really free?",
      answer: "Yes, our basic AEO audit is completely free with no strings attached. Premium detailed reports are available for comprehensive analysis."
    }
  ],
  ...
  '/plans': [
    {
      ...
      answer: "We offer Starter (free audit), Growth (monthly optimization), and Enterprise (custom solutions) plans to fit different business needs and budgets."
    },
    {
      question: "Can I change plans later?",
      answer: "Yes, you can upgrade or downgrade your plan at any time. Changes take effect at your next billing cycle with pro-rated adjustments."
    },
    {
  ...
  '/calculators': [
    {
      ...
      answer: "Yes, all our business calculators (ROI, pricing, conversion) are completely free to use with no registration required."
    },
    {
      question: "How accurate are the calculations?",
      answer: "Our calculators use industry-standard formulas and benchmarks. Results are estimates for planning purposes and should be verified with actual data."
    }
  ]
};
...
export const PAGE_SERVICE_CONTENT: Record<string, ServiceData> = {
  ...
  '/seo-analyzer': {
    ...
    description: "Advanced SEO analysis tool providing comprehensive business profile analysis, keyword strategies, and local SEO recommendations for premium users.",
    provider: {
      name: "XenlixAI",
      url: "https://xenlix.ai"
    },
  ...
  '/schema-generator': {
    ...
    description: "Automated schema markup generation tool for businesses to improve search engine visibility and rich snippet appearance.",
    provider: {
      name: "XenlixAI", 
      url: "https://xenlix.ai"
    },
  ...
  '/ai-seo-automation': {
    ...
    description: "Automated SEO optimization using artificial intelligence to improve search rankings, content optimization, and technical SEO implementation.",
    provider: {
      name: "XenlixAI",
      url: "https://xenlix.ai"
    },
...
export const PAGE_PRODUCT_CONTENT: Record<string, ProductData> = {
  ...
  '/dashboard': {
    ...
    description: "Comprehensive analytics dashboard providing AI search visibility metrics, SEO performance tracking, and business growth insights.",
    brand: {
      name: "XenlixAI"
    },
  ...
  return {
    ...
    ...(serviceData.offers && {
      "offers": {
        ...
        ...(serviceData.offers.priceCurrency && { "priceCurrency": serviceData.offers.priceCurrency }),
        ...(serviceData.offers.priceValidUntil && { "priceValidUntil": serviceData.offers.priceValidUntil }),
  ...
  return {
    ...
    ...(productData.offers && {
      "offers": {
        ...
        ...(productData.offers.priceCurrency && { "priceCurrency": productData.offers.priceCurrency }),
        ...(productData.offers.availability && { "availability": `https://schema.org/${productData.offers.availability}` }),
