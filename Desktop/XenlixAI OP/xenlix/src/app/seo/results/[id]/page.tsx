    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-100 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="text-center">
            <div className={`inline-flex items-center justify-center w-32 h-32 rounded-full ${getScoreBgColor(analysisData.overallScore)} mb-4`}>
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Your website scored {analysisData.overallScore} out of 100. This score reflects your site's 
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                ...
                <span className={`px-3 py-1 rounded-full text-sm ${analysisData.technicalSeo.hasMetaDescription ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                ...
                <span className={`px-3 py-1 rounded-full text-sm ${analysisData.technicalSeo.titleLength >= 30 && analysisData.technicalSeo.titleLength <= 60 ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                ...
                <span className={`px-3 py-1 rounded-full text-sm ${analysisData.technicalSeo.hasH1 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                ...
                <span className={`px-3 py-1 rounded-full text-sm ${analysisData.technicalSeo.hasSchema ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                ...
                <span className={`px-3 py-1 rounded-full text-sm ${getScoreColor(analysisData.technicalSeo.pageSpeed)} ${getScoreBgColor(analysisData.technicalSeo.pageSpeed)}`}>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <div className="text-3xl font-bold text-green-600 mb-2">{analysisData.contentAnalysis.contentQuality}</div>
              <div className="text-sm text-gray-600">Quality Score</div>
            </div>
            
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              <div className="text-3xl font-bold text-purple-600 mb-2">{analysisData.contentAnalysis.topicCoverage}</div>
              <div className="text-sm text-gray-600">Topic Coverage</div>
            </div>
            
            <div className="text-center p-4 bg-orange-50 rounded-lg">
              <div className="text-3xl font-bold text-orange-600 mb-2">{analysisData.contentAnalysis.readability}</div>
