        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-lg mb-4">
              AI Engine Optimization analysis for: <span className="font-semibold">{analysisData.url}</span>
            </p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Your content scored {analysisData.aeoOptimization.overallAeoScore} out of 100 for AI Engine Optimization. 
              This measures how well your content is structured for AI-powered search engines and chatbots.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-blue-50 rounded-lg">
              <div className="text-3xl font-bold text-blue-600 mb-2">{analysisData.aeoOptimization.questionIntentScore}</div>
              <div className="font-semibold text-gray-900 mb-2">Question Intent</div>
              <div className="text-sm text-gray-600">How well your content answers user questions</div>
            </div>
            
            <div className="text-center p-6 bg-indigo-50 rounded-lg">
              <div className="text-3xl font-bold text-indigo-600 mb-2">{analysisData.aeoOptimization.answerReadinessScore}</div>
            ...
            <div className="text-center p-6 bg-purple-50 rounded-lg">
              <div className="text-3xl font-bold text-purple-600 mb-2">{analysisData.aeoOptimization.conversationalToneScore}</div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-4 border border-gray-200 rounded-lg">
              <div className="text-2xl font-bold text-green-600 mb-2">{analysisData.aiEngineOptimization.googleAI.score}</div>
              <div className="text-sm font-medium text-gray-900">Google AI</div>
            </div>
            
            <div className="text-center p-4 border border-gray-200 rounded-lg">
              <div className="text-2xl font-bold text-blue-600 mb-2">{analysisData.aiEngineOptimization.openAI.score}</div>
              <div className="text-sm font-medium text-gray-900">OpenAI</div>
            </div>
            
            <div className="text-center p-4 border border-gray-200 rounded-lg">
              <div className="text-2xl font-bold text-purple-600 mb-2">{analysisData.aiEngineOptimization.anthropic.score}</div>
              <div className="text-sm font-medium text-gray-900">Anthropic</div>
            </div>
            
            <div className="text-center p-4 border border-gray-200 rounded-lg">
              <div className="text-2xl font-bold text-orange-600 mb-2">{analysisData.aiEngineOptimization.perplexity.score}</div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className={`px-2 py-1 rounded text-sm ${analysisData.technicalSeo.hasMetaDescription ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                    {analysisData.technicalSeo.hasMetaDescription ? 'Present' : 'Missing'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Title Length</span>
                  <span className="font-semibold">{analysisData.technicalSeo.titleLength} chars</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Images with Alt Text</span>
                  <span className="font-semibold">{analysisData.technicalSeo.hasAltTags}/{analysisData.technicalSeo.totalImages}</span>
                </div>
              </div>
            </div>
          </div>
