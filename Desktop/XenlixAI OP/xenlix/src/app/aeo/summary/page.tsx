...
import { ArrowRight, Lock, AlertCircle, Sparkles, TrendingUp, MessageSquare } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-12">
        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
            <div className="lg:text-left mb-4 lg:mb-0">
              <div className="flex items-center justify-center lg:justify-start mb-2">
                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-brand-gradient text-white mr-3 shadow-sm">
                  <Sparkles className="h-3 w-3 mr-1" />
                  AEO Preview
                </span>
              </div>
              <h2 className="text-2xl lg:text-3xl font-bold mb-2 text-brand-gradient leading-tight">
            ...
            <div className="flex-shrink-0">
              <button
                ...
                className="inline-flex items-center px-6 py-3 bg-[var(--brand-500)] hover:bg-[var(--brand-600)] text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-purple"
                aria-label="Purchase full AEO and SEO analysis"
              >
                <span className="text-sm lg:text-base">Get Full AEO Report</span>
        ...
        {/* Business Information & Visibility Map */}
        <div className="mb-16">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-base lg:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed max-w-prose">
              Here's what we discovered about your business profile and location visibility
            </p>
          </motion.div>
          ...
          <div className="mb-16 max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4 leading-tight">
                AI Engine Analysis Preview
              </h2>
              <p className="text-base lg:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                See how ChatGPT, Claude, and Perplexity evaluate your content
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="font-semibold text-gray-900">ChatGPT Readiness</h3>
                </div>
                <div className="space-y-3">
                  ...
                  <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="mt-2 text-center">
                      ...
                      <span className="text-xs text-gray-400">Full analysis locked</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="font-semibold text-gray-900">Claude Analysis</h3>
                </div>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold text-red-600">Weak</span>
                  </div>
                  <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                    <p className="text-xs text-gray-600 italic">
                    ...
                    <div className="mt-2 text-center">
                      <Lock className="h-4 w-4 text-gray-400 mx-auto" />
                      <span className="text-xs text-gray-400">Full recommendations locked</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="font-semibold text-gray-900">Perplexity Index</h3>
                </div>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Source Ranking</span>
                  ...
                  <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="mt-2 text-center">
                      <Lock className="h-4 w-4 text-gray-400 mx-auto" />
                      <span className="text-xs text-gray-400">Detailed insights locked</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                {data.quickFindings.slice(0, 4).map((finding, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="text-sm text-gray-800 font-medium">{finding}</p>
                      <div className="mt-2 flex items-center text-xs text-gray-500">
                        <Lock className="h-3 w-3 mr-1" />
                        <span>Fix instructions in full report</span>
                      </div>
                    </div>
                  </div>
                ))}
                ...
                <div className="text-center mt-6">
                  <div className="inline-flex items-center px-4 py-2 bg-white border border-red-200 rounded-lg shadow-sm">
                    ...
                    <span className="text-sm text-gray-700">
                      +{data.quickFindings.length - 4} more issues found
                    </span>
                  </div>
                </div>
              )}
              ...
              <div className="relative z-30 p-8">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    ...
                    <span className="text-red-600 font-semibold">-23 points</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-sm text-gray-600">vs. competitor2.com</span>
                    <span className="text-green-600 font-semibold">+7 points</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-sm text-gray-600">vs. competitor3.com</span>
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                  ...
                  <ul className="text-xs text-gray-500 space-y-1">
                    <li>• Competitors using advanced schema markup</li>
                    <li>• Missing FAQ sections hurt your rankings</li>
                ...
                <div className="absolute bottom-4 left-8 right-8">
                  <div className="bg-white/90 backdrop-blur-sm border border-gray-200 rounded-lg p-3 text-center">
                    ...
                    <p className="text-sm font-medium text-gray-700">Full Competitor Analysis</p>
                    <p className="text-xs text-gray-500">Detailed gap analysis & action items</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative z-30 p-8">
                ...
                <div className="absolute bottom-4 left-8 right-8">
                  <div className="bg-gray-800/90 backdrop-blur-sm border border-gray-600 rounded-lg p-3 text-center">
                    <Lock className="h-6 w-6 text-gray-400 mx-auto mb-2" />
                    <p className="text-sm font-medium text-gray-200">Complete Data Export</p>
                    <p className="text-xs text-gray-400">All metrics in machine-readable format</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative z-30 p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-gray-600">Schema markup implemented</span>
                    <span className="text-green-600 text-sm font-medium ml-auto">+12 pts</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-4 h-4 bg-yellow-500 rounded-full"></div>
                    <span className="text-sm text-gray-600">FAQ section in progress</span>
                    <span className="text-yellow-600 text-sm font-medium ml-auto">pending</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-4 h-4 bg-gray-300 rounded-full"></div>
                    <span className="text-sm text-gray-600">Entity optimization queued</span>
                ...
                <div className="absolute bottom-4 left-8 right-8">
                  <div className="bg-white/90 backdrop-blur-sm border border-gray-200 rounded-lg p-3 text-center">
                    <Lock className="h-6 w-6 text-gray-400 mx-auto mb-2" />
                    <p className="text-sm font-medium text-gray-700">Live Progress Dashboard</p>
                    <p className="text-xs text-gray-500">Track improvements over time</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-200">
              ...
              <div className="relative z-30 p-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between text-xs">
                        <span className="text-gray-500">Business hours queries</span>
                        <span className="text-green-600">↑ 34%</span>
                      </div>
                      <div className="flex justify-between text-xs">
                        <span className="text-gray-500">Service-related searches</span>
                        <span className="text-green-600">↑ 18%</span>
                      </div>
                      <div className="flex justify-between text-xs">
                        <span className="text-gray-500">Location-based queries</span>
                ...
                <div className="absolute bottom-4 left-8 right-8">
                  <div className="bg-white/90 backdrop-blur-sm border border-gray-200 rounded-lg p-3 text-center">
                    <Lock className="h-6 w-6 text-gray-400 mx-auto mb-2" />
                    <p className="text-sm font-medium text-gray-700">6-Month Analytics</p>
                    <p className="text-xs text-gray-500">Detailed performance history</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Pricing Section with Key Deliverables */}
          ...
          <div className="relative z-10">
            ...
            <div className="mb-16">
              <div className="text-center mb-8">
                ...
                <p className="text-base lg:text-lg text-white/90 max-w-2xl mx-auto leading-relaxed max-w-prose">
                  Based on your current analysis, here are the key improvements you can unlock
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {buildPreviewBenefits({
                    ...
                    <motion.div
                      ...
                      className="flex items-start space-x-3 bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300"
                    >
                      <div className="flex-shrink-0 mt-1">
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                ...
                <p className="text-base lg:text-lg text-white/90 max-w-2xl mx-auto leading-relaxed max-w-prose">
                  Here's exactly what you'll receive when you unlock your complete analysis
                </p>
              </div>
              ...
              {/* Value Emphasis */}
              <div className="text-center mt-12 bg-white/5 rounded-2xl p-8 border border-white/10 hover:bg-white/10 transition-all duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/15 hover:scale-105 transition-all duration-300 hover:shadow-xl">
                ...
                <button
                  ...
                  className="w-full bg-[#F97316] text-white font-bold py-3 px-6 rounded-lg hover:bg-[#EA580C] transition-all duration-200 flex items-center justify-center shadow-lg hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400/40"
                >
                  <span className="text-sm lg:text-base">Access Analytics Dashboard - $47</span>
                  <ArrowRight className="h-4 w-4 ml-2" />
                </button>
              ...
              {/* Premium Plan */}
              <div className="bg-white/15 backdrop-blur-sm rounded-2xl p-8 border-2 border-[#F97316] relative hover:bg-white/20 hover:scale-105 transition-all duration-300 hover:shadow-xl">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <div className="bg-[#F97316] text-white px-4 py-1 rounded-full text-sm font-bold shadow-lg">
                    MOST POPULAR
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-[#F97316] text-white font-bold py-3 px-6 rounded-lg hover:bg-[#EA580C] transition-all duration-200 flex items-center justify-center shadow-lg hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400/40"
                >
                  <span className="text-sm lg:text-base">Full Dashboard + Tracking - $97</span>
                  <ArrowRight className="h-4 w-4 ml-2" />
                </button>
                <div className="mt-3 text-center">
                  <div className="inline-flex items-center text-xs text-white/80 bg-white/10 rounded-lg px-3 py-1">
                    <Sparkles className="w-3 h-3 mr-1" />
                    Most popular: Complete analytics platform
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Final Dashboard Preview & Urgency */}
        <div className="mt-16 mb-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 1.0 }}
            className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-8 text-white relative overflow-hidden"
          >
            ...
            <div className="relative z-10">
              ...
              <div className="text-center">
                <div className="inline-flex items-center space-x-4">
                  <button
                    onClick={() => handleUpgradeClick('basic')}
                    className="bg-white text-gray-900 font-bold py-4 px-8 rounded-xl hover:bg-gray-100 transition-all duration-200 flex items-center shadow-xl"
                  >
                    <span>Start with Basic Dashboard - $47</span>
                    <ArrowRight className="h-5 w-5 ml-2" />
                  </button>
                  <span className="text-gray-400">or</span>
                  <button
                    onClick={() => handleUpgradeClick('premium')}
                    className="bg-gradient-to-r from-orange-500 to-orange-600 text-white font-bold py-4 px-8 rounded-xl hover:from-orange-600 hover:to-orange-700 transition-all duration-200 flex items-center shadow-xl"
                  >
                    <span>Get Complete Platform - $97</span>
                    <ArrowRight className="h-5 w-5 ml-2" />
                  </button>
                </div>
