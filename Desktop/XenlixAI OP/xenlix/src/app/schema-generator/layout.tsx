...
export const metadata: Metadata = {
  ...
  description:
    'Generate structured data (JSON-LD schema markup) for your business to improve SEO and AI search visibility. Free schema generator for local business, FAQ, product, and organization markup.',
  keywords:
    'schema generator, JSON-LD generator, structured data generator, schema markup, local business schema, FAQ schema, SEO schema',
  openGraph: {
    title: 'Schema Generator | Free JSON-LD Structured Data Generator - XenlixAI',
    description:
      'Generate structured data (JSON-LD schema markup) for your business to improve SEO and AI search visibility. Free schema generator for local business, FAQ, product, and organization markup.',
