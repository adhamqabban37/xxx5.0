        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold mb-6">{study.title}</h1>

              <p className="text-xl text-white/90 mb-8">{study.summary}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {study.results.map((result, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg text-center">
                <div className="text-3xl font-bold text-primary mb-2">{result.improvement}</div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <cite className="font-semibold text-gray-900">{study.testimonial.author}</cite>
              ...
              dangerouslySetInnerHTML={{
                __html:
                  study.content
                    .replace(/\n/g, '<br>')
                    .replace(/#{1,3} /g, '<h3>')
                    .replace(/<h3>/g, '</p><h3 class="text-2xl font-bold text-gray-900 mb-4 mt-8">')
