...
export function generateHomepageSchema(config: HomepageSchemaConfig) {
  const { baseUrl, organizationName, description, address, phone, email, sameAs, logo, aggregateRating, geo, openingHours, priceRange } = config;
...
export const XENLIX_HOMEPAGE_CONFIG: HomepageSchemaConfig = {
  ...
  description: "AI-powered Answer Engine Optimization (AEO) platform helping businesses get found in ChatGPT, Claude, Perplexity, and other AI search engines. Comprehensive SEO automation and analytics dashboard.",
  address: {
