...
export const metadata: Metadata = {
  ...
  description:
    'Import and normalize your business profile from Google My Business, Yelp, Facebook, or custom JSON format for AI optimization.',
};
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Business Profile Import</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Import your business data from popular platforms and normalize it into a standard
            structure for AI-powered optimization and marketing automation.
          </p>
        </div>
        ...
        <div className="mt-12 bg-white rounded-lg shadow p-6">
          ...
          <div className="bg-gray-900 rounded-lg p-4 text-sm">
            <code className="text-green-400">
              ...
              <span className="text-yellow-300">/api/business/import</span>
              <br />
          ...
          <p className="text-gray-600 mt-4 text-sm">
            <strong>Response:</strong> Normalized business profile with optimization recommendations
