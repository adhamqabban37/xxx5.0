...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      "Get found in ChatGPT, Claude & AI search with our free AEO audit. Discover why you're invisible + get actionable fixes in 60 seconds. Start now!",
    keywords:
      'AEO audit, answer engine optimization, ChatGPT SEO, AI search optimization, free website audit, AI visibility, get found in AI search',
  };
}
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10">
        ...
        <HomeContent faqSchema={faqSchema} orgSchema={orgAggregateRatingJsonLd(average, count)} />
      </div>
    </div>
  );
}
