...
export const metadata: Metadata = {
  ...
  description: "Advanced SEO strategy analyzer for premium users. Get comprehensive business profile analysis, keyword strategies, and local SEO recommendations.",
