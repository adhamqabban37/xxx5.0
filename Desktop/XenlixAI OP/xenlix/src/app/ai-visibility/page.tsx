/**
 * AI Visibility Analytics Page
 * Comprehensive analytics dashboard for AI search engine visibility
 */
...
export default function AIVisibilityAnalytics() {
  const [data, setData] = useState<AIVisibilityAnalytics | null>(null);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [selectedTab, setSelectedTab] = useState<
    'overview' | 'brands' | 'prompts' | 'engines' | 'sources'
  >('overview');
      ...
      const analytics: AIVisibilityAnalytics = {
        summary: {
          ...
          total_mentions: summaryData.brand_summaries.reduce(
            (sum: number, b: any) => sum + b.total_mentions,
            0
          ),
          total_answers: summaryData.brand_summaries.reduce(
            (sum: number, b: any) => sum + b.total_answers,
            0
          ),
        ...
        brands: summaryData.brand_summaries.map((brand: any) => ({
          id: brand.brand_id,
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">AI Visibility Analytics</h1>
