...
export default function Testimonials() {
  return (
    <section aria-labelledby="testimonials-heading" className="relative py-16 px-4 sm:px-6 lg:px-8">
      {/* Background */}
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See how businesses across industries are winning with Answer Engine Optimization and
