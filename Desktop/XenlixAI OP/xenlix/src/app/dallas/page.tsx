...
export default function DallasPage() {
  ...
  const serviceSchema = serviceJsonLd({
    ...
    description:
      'Get found in ChatGPT, Gemini, Copilot and Google with AI-optimized marketing for Dallas businesses',
    city: 'Dallas',
    price: '2400',
    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              The DFW market is evolving fast. Your customers are asking AI assistants for
              recommendations, and your competitors are getting mentioned instead of you.
            </p>
          </div>
            ...
            {[
              {
                title: 'AEO Checklist',
                description:
                  '15-point optimization framework to get mentioned by ChatGPT, Gemini, and Copilot',
                icon: '✓',
              },
              {
                title: 'GBP/Bing/Apple Optimization',
                description:
                  'Complete local search optimization across all major platforms and AI engines',
                icon: '📍',
              },
              {
                title: 'Review Engine',
                description:
                  'Automated system to generate and optimize customer reviews for AI consumption',
                icon: '⭐',
              },
              {
                title: 'AI Ad Creator',
                description:
                  'Google PMax, Search, Bing, Meta, and TikTok campaigns optimized for Dallas market',
                icon: '🎯',
              },
              {
                title: '14-Day Ramp Plan',
                description:
                  'Proven playbook to see initial AI mentions and traffic lift within 2 weeks',
                icon: '🚀',
              },
              {
                title: 'Local Content Strategy',
                description:
                  'Dallas-specific content that resonates with DFW customers and AI assistants',
                icon: '📝',
              },
            ].map((item, index) => (
              <div
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8">Results in Dallas</h2>
      ...
      <section className="py-16 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-8">Ready to Dominate Dallas Search?</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We understand the Dallas market because we're part of it. Local expertise meets AI
              innovation.
            </p>
          </div>
