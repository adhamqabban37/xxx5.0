...
export const metadata: Metadata = {
  ...
  description:
    'Free business calculators for ROI analysis and pricing estimation. Calculate advertising ROI, customer acquisition costs, and subscription pricing with our AI-powered tools.',
  keywords:
    'ROI calculator, pricing calculator, CAC calculator, business tools, advertising ROI, subscription pricing',
  openGraph: {
