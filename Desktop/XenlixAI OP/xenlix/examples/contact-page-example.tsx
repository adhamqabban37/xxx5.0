...
export const metadata: Metadata = {
  ...
  description: "Get in touch with XenlixAI for AI marketing automation, AEO services, and business growth solutions. Our team is ready to help you scale with AI.",
  robots: "index, follow",
  openGraph: {
    title: "Contact XenlixAI | AI Marketing Support & Consultation",
    description: "Connect with our AI marketing experts for personalized business growth solutions.",
    type: "website",
  },
  alternates: {
    canonical: "/contact"
    ...
    <>
      ...
      <BreadcrumbSchema 
        webPageProps={{
          ...
          description: "Get in touch with XenlixAI for AI marketing automation, AEO services, and business growth solutions.",
