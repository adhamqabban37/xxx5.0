...
export const metadata: Metadata = {
  ...
  description:
    'Calculate your marketing ROI and business investment returns with our free calculator. Make data-driven decisions for your marketing campaigns.',
  robots: 'index, follow',
  alternates: {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Calculate your return on investment for marketing campaigns, business tools, and
